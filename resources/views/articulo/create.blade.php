...
<title>@yield('title') Registrar Articulo</title>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center">
                        ...
                        <h2 class="font-weight-bold text-dark">Registrar Articulo</h2>
                   ...
                   <div class="row justify-content-center my-4">
                    ...
                    <form method="post" action="{{ route('articulo.store') }}" enctype="multipart/form-data" onsubmit="return articulo(this)" id="Mobiliario" style="" class="formulario active">
                        ...
                        <div class="card-body">
                            ...
                            <center><h3 class="font-weight-bold text-dark">Registrar Mobiliario</h3></center>
                    ...
                    <form method="post" action="{{ route('articulo.store') }}" enctype="multipart/form-data" onsubmit="return articulo_equipo(this)" id="Equipo" style="" class="formulario inactive">
                        @csrf
                        <div class="card-body">

                            <center><h3 class="font-weight-bold text-dark">Registrar Equipo</h3></center>
