                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="nombre_modelo" name="nombre_modelo" style="background: white;" value="" placeholder="Ingrese El nombre del modelo" autocomplete="off" oninput="capitalizarInput('nombre_modelo')" onkeypress="return soloLetrasNumero(event);">
                                    </div>
