                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="cedula" name="cedula" style="background: white;" value="{{ $persona->cedula }}" placeholder="Ingrese la Cedula" autocomplete="off" onkeypress="return solonum(event);">
                                </div>
