                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <h2 class="font-weight-bold text-dark">Gestión de Personas</h2>
                    ...
                    <table class="table align-items-center table-flush" id="dataTable">
                        <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="font-weight-bold text-dark">Oficina</th>
                                ...
                                <tbody>
                                    @foreach ($personas as $persona)
                                        <tr>
                                            ...
                                            <td class="font-weight-bold text-dark">{{ $persona->email }}</td>
                                            <td class="font-weight-bold text-dark">{{ $persona->telefono }}</td>
                                            <td class="font-weight-bold text-dark">{{ $persona->oficina->nombre_oficina ?? 'N/A' }}</td>

                                            <td>
                                                <div style="display: flex; justify-content: center;">
                                                    @can('editar-persona')
                                                        <a class="btn btn-warning btn-sm" href="{{ route('persona.edit', $persona->id) }}">
