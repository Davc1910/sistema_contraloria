              ...
              <div class="col-md-12">
                ...
                <form method="post" action="{{ route('persona.store') }}" enctype="multipart/form-data" onsubmit="return Personas(this)">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="apellido" name="apellido" style="background: white;" value="" placeholder="Ingrese el Apellido" oninput="capitalizarInput('apellido')" autocomplete="off" onkeypress="return soloLetras(event);">
                            </div>

                            <div class="col-4">
                                <label  class="font-weight-bold text-dark">Correo</label>
                                <input type="email" class="form-control" id="email" name="email" style="background: white;" value="" placeholder="Ingrese el Correo" autocomplete="off">
                            </div>

                            <div class="col-4">
                                <label  class="font-weight-bold text-dark">Telefono</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" style="background: white;" value="" placeholder="Ingrese el Telefono" autocomplete="off" onkeypress="return solonum(event);">
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select" id="id_oficina" name="id_oficina">
                                    ...
                                    @foreach($oficinas as $oficina)
                                        <option value="{{ $oficina->id }}"> {{ $oficina->encargado_cedula }} {{ $oficina->nombre_encargado }} / {{ $oficina->nombre_oficina }} </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <center>
                        ...
                        <a class="btn btn-info btn-lg" href="{{ url('persona') }}"><span class="icon text-white-50">
