...
<title>@yield('title') Perifericos</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <h2 class="font-weight-bold text-dark">Gestión de Perifericos</h2>

                        @can('crear-periferico')
                            <form action="{{ route('periferico.create') }}" method="get" style="display:inline;">
                    ...
                    <div class="table-responsive p-3">
                        <table class="table align-items-center table-flush" id="dataTable">
                            <thead class="thead-light">
                                <tr>
                                    <th class="font-weight-bold text-dark">Tipo de Periférico</th>
                                    <th class="font-weight-bold text-dark">Marca</th>
                                    <th class="font-weight-bold text-dark">Modelo</th>
                            ...
                            <tbody>
                                @foreach ($perifericos as $periferico)
                                        ...
                                        <td class="font-weight-bold text-dark">{{ $periferico->tipo_periferico->tipo ?? 'N/A' }}</td>
                                        <td class="font-weight-bold text-dark">{{ $periferico->marca->nombre_marca ?? 'N/A'  }}</td>
                                        <td class="font-weight-bold text-dark">{{ $periferico->modelo->nombre_modelo ?? 'N/A'  }}</td>
                                        <td class="font-weight-bold text-dark">{{ $periferico->serial }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex; justify-content: center;">
                                                ...
                                                @can('editar-periferico')
                                                    <a class="btn btn-warning btn-sm" href="{{ route('periferico.edit',$periferico->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                        <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
                                                    </svg></a>
                                                @endcan

                                                @can('borrar-periferico')
                                                    <form action="{{ route('periferico.destroy', $periferico->id) }}" method="POST" class="sweetalert" style="margin: 0 3px;">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
