...
<title>@yield('title') Actualizar Periférico</title>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-center">
                    ...
                    <h2 class="font-weight-bold text-dark">Actualizar Periférico</h2>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select" id="id_tipo" name="id_tipo">
                                    ...
                                    @foreach($tipo_perifericos as $tipo_periferico)
                                        <option value="{{ $tipo_periferico->id }}" {{ $periferico->id_tipo == $tipo_periferico->id ? 'selected' : '' }}> {{ $tipo_periferico->tipo }} </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select" id="id_marca" name="id_marca">
                                    ...
                                    @foreach($marcas as $marca)
                                        <option value="{{ $marca->id }}" {{ $periferico->id_marca == $marca->id ? 'selected' : '' }}> {{ $marca->nombre_marca }} </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select" id="id_modelo" name="id_modelo">
                                    ...
                                    @foreach($modelos as $modelo)
                                        <option value="{{ $modelo->id }}" {{ $periferico->id_modelo == $modelo->id ? 'selected' : '' }}> {{ $modelo->nombre_modelo }} </option>
                                    @endforeach
                                </select>
                            </div>
